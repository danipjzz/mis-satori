...
exports.crearVenta = async (req, res) => {
  const { producto, cantidad, precio_unitario, nombre, telefono, correo, metodo_pago } = req.body;
  ...
  try {
    ...
    const result = await db.query(
      `INSERT INTO ventas(producto, cantidad, precio_unitario, total, cliente_id, metodo_pago)
       VALUES($1, $2, $3, $4, $5, $6)
       RETURNING *`,
      [producto, cantidad, precio_unitario, total, cliente_id, metodo_pago || null]
    );
